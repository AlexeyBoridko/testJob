...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'testTicketsApp_modelchangeslog', (
        ...
        db.send_create_signal(u'testTicketsApp', ['ModelChangesLog'])


    def backwards(self, orm):
        # Deleting model 'ModelChangesLog'
        db.delete_table(u'testTicketsApp_modelchangeslog')
