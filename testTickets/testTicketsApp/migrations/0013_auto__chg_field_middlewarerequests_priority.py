...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MiddlewareRequests.priority'
        db.alter_column(u'testTicketsApp_middlewarerequests', 'priority', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'MiddlewareRequests.priority'
        db.alter_column(u'testTicketsApp_middlewarerequests', 'priority', self.gf('django.db.models.fields.BooleanField')())
